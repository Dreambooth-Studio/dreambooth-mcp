...
const SCENARIOS: Scenario[] = [
  ...
  {
    file: "gen-booth-draft-edited-light.html",
    label: `${GENERATION_WIDGET_URI} — booth draft after update_booth_draft, light`,
    html: generationWidgetHtml,
    theme: "light",
    // What update_booth_draft answers: the draft, what landed, what did not.
    toolOutput: {
      kind: "booth-draft",
      jobId: "",
      state: "done",
      ...
      draft: {
        ...
        filterIds: ["66f1c0ffee0000000000beef"],
        edited: ["capture.captureCount=4", "1 filter(s) chosen"],
      },
      applied: ["cta", "settings.capture.captureCount", "filterIds"],
